...
{id:'aldhelm',name:{en:'Aldhelm',bn:'অ্যাল্ডহেলম'},birth:'c. 639',death:'709',period:'old-english',intro:{en:'Bishop and the first major writer of Anglo-Latin verse.',bn:'বিশপ এবং অ্যাংলো-ল্যাটিন পদ্যের প্রথম প্রধান লেখক।'},description:{en:'Aldhelm was the first great English writer, composing influential Latin prose and verse while also being noted for his Old English poetry.',bn:'অ্যাল্ডহেলম প্রথম মহান ইংরেজ লেখক ছিলেন।'},majorWorks:{en:['De Virginitate'],bn:['ডি ভার্জিনিটেট']},style:{en:'Ornate, complex Latin prose with riddles.',bn:'ধাঁধা সহ অলঙ্কৃত ল্যাটিন গদ্য।'},contribution:{en:'Established the tradition of Anglo-Latin scholarship.',bn:'অ্যাংলো-ল্যাটিন পাণ্ডিত্যের ঐতিহ্য প্রতিষ্ঠা করেন।'},quotes:{en:['Let none despise the power of learning.'],bn:['কেউ যেন জ্ঞানের শক্তিকে তুচ্ছ না করে।']}},
{id:'wulfstan',name:{en:'Wulfstan',bn:'উলফস্ট্যান'},birth:'c. 960',death:'1023',period:'old-english',intro:{en:'Archbishop of York, author of the powerful Sermo Lupi.',bn:'ইয়র্কের আর্চবিশপ, শক্তিশালী সেরমো লুপির লেখক।'},description:{en:'Wulfstan was a prolific homilist whose fiery Sermo Lupi ad Anglos denounced the moral decline of England during Viking invasions.',bn:'উলফস্ট্যান একজন সফল ধর্মোপদেশক ছিলেন।'},majorWorks:{en:['Sermo Lupi ad Anglos'],bn:['সেরমো লুপি অ্যাড অ্যাংলোস']},style:{en:'Rhythmic, urgent, and powerfully rhetorical prose.',bn:'ছন্দময় এবং শক্তিশালী অলংকারপূর্ণ গদ্য।'},contribution:{en:'Created the most passionate political prose of the Old English period.',bn:'পুরানো ইংরেজি যুগের সবচেয়ে আবেগপূর্ণ রাজনৈতিক গদ্য তৈরি করেন।'},quotes:{en:['The world is in haste, and it nears the end.'],bn:['পৃথিবী ছুটছে, আর শেষের কাছাকাছি।']}},
{id:'aelfric',name:{en:'Ælfric of Eynsham',bn:'অ্যালফ্রিক'},birth:'c. 955',death:'c. 1010',period:'old-english',intro:{en:'The most prolific writer of Anglo-Saxon prose.',bn:'অ্যাংলো-স্যাক্সন গদ্যের সবচেয়ে সফল লেখক।'},description:{en:'Ælfric produced homilies, saints\' lives, and educational texts. His clear prose style established standards for Old English.',bn:'অ্যালফ্রিক ধর্মোপদেশ ও শিক্ষামূলক গ্রন্থ তৈরি করেছিলেন।'},majorWorks:{en:['Catholic Homilies','Lives of Saints'],bn:['ক্যাথলিক হোমিলিজ','লাইভস অফ সেইন্টস']},style:{en:'Clear, rhythmic, and didactic prose.',bn:'স্পষ্ট, ছন্দময় এবং শিক্ষামূলক গদ্য।'},contribution:{en:'Standardized Old English prose.',bn:'পুরানো ইংরেজি গদ্যকে মানসম্মত করেন।'},quotes:{en:['We are pilgrims on this earth.'],bn:['আমরা এই পৃথিবীতে তীর্থযাত্রী।']}},
{id:'margery-kempe',name:{en:'Margery Kempe',bn:'মার্জারি কেম্পে'},birth:'c. 1373',death:'c. 1438',period:'middle-english',intro:{en:'Author of the first autobiography in English.',bn:'ইংরেজিতে প্রথম আত্মজীবনীর লেখিকা।'},description:{en:'Margery Kempe dictated The Book of Margery Kempe, the first autobiography in English, providing insight into medieval female spirituality.',bn:'মার্জারি কেম্পে ইংরেজিতে প্রথম আত্মজীবনী লিখিয়েছিলেন।'},majorWorks:{en:['The Book of Margery Kempe'],bn:['দ্য বুক অফ মার্জারি কেম্পে']},style:{en:'Vivid, emotional, and confessional prose.',bn:'প্রাণবন্ত, আবেগপূর্ণ গদ্য।'},contribution:{en:'Pioneered autobiographical writing in English.',bn:'ইংরেজিতে আত্মজীবনীমূলক লেখার পথিকৃৎ।'},quotes:{en:['This creature wept and sobbed so plentifully.'],bn:['এই প্রাণী এত প্রচুর কেঁদেছিল।']}},
{id:'john-lydgate',name:{en:'John Lydgate',bn:'জন লিডগেট'},birth:'c. 1370',death:'c. 1451',period:'middle-english',intro:{en:'The most prolific English poet of the 15th century.',bn:'১৫ শতকের সবচেয়ে সফল ইংরেজ কবি।'},description:{en:'Lydgate was a Benedictine monk who produced an enormous body of poetry. He was the most widely read English poet of his century.',bn:'লিডগেট একজন বেনেডিক্টাইন সন্ন্যাসী ছিলেন।'},majorWorks:{en:['Troy Book','The Fall of Princes'],bn:['ট্রয় বুক','দ্য ফল অফ প্রিন্সেস']},style:{en:'Elaborate, Chaucerian narrative verse.',bn:'বিস্তৃত, চসারীয় আখ্যানমূলক কবিতা।'},contribution:{en:'Extended the Chaucerian tradition in Middle English.',bn:'মধ্য ইংরেজিতে চসারীয় ঐতিহ্য বিস্তৃত করেন।'},quotes:{en:['All is but change in this world unstable.'],bn:['এই অস্থির পৃথিবীতে সবই পরিবর্তনশীল।']}},
{id:'andrew-marvell',name:{en:'Andrew Marvell',bn:'অ্যান্ড্রু মার্ভেল'},birth:'1621',death:'1678',period:'renaissance',image:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Andrew_Marvell.jpg/220px-Andrew_Marvell.jpg',intro:{en:'Metaphysical poet known for "To His Coy Mistress."',bn:'মেটাফিজিক্যাল কবি, "টু হিজ কয় মিস্ট্রেস" এর জন্য পরিচিত।'},description:{en:'Marvell combined lyrical grace with political engagement, bridging Metaphysical and Augustan traditions.',bn:'মার্ভেল গীতিময় কৃপা এবং রাজনৈতিক সম্পৃক্ততাকে একত্রিত করেছিলেন।'},majorWorks:{en:['To His Coy Mistress','The Garden','An Horatian Ode'],bn:['টু হিজ কয় মিস্ট্রেস','দ্য গার্ডেন','অ্যান হোরেশিয়ান ওড']},style:{en:'Witty, metaphysical, and politically sharp.',bn:'রসিকতাপূর্ণ এবং রাজনৈতিকভাবে তীক্ষ্ণ।'},contribution:{en:'Bridged Metaphysical and Augustan poetry.',bn:'মেটাফিজিক্যাল এবং অগাস্টান কবিতার মধ্যে সেতুবন্ধন করেন।'},quotes:{en:['Had we but world enough, and time.'],bn:['আমাদের যদি যথেষ্ট পৃথিবী ও সময় থাকতো।']}},
{id:'george-herbert',name:{en:'George Herbert',bn:'জর্জ হার্বার্ট'},birth:'1593',death:'1633',period:'renaissance',intro:{en:'Leading devotional poet of the 17th century.',bn:'১৭ শতকের প্রধান ভক্তিমূলক কবি।'},description:{en:'Herbert\'s poetry collection The Temple explores the relationship between the human soul and God with remarkable technical invention.',bn:'হার্বার্টের কবিতা সংকলন দ্য টেম্পল মানব আত্মা এবং ঈশ্বরের সম্পর্ক অন্বেষণ করে।'},majorWorks:{en:['The Temple','Easter Wings','The Collar'],bn:['দ্য টেম্পল','ইস্টার উইংস','দ্য কলার']},style:{en:'Inventive, devotional, with shaped verse.',bn:'উদ্ভাবনী, ভক্তিমূলক এবং আকৃতি-কবিতায় সমৃদ্ধ।'},contribution:{en:'Established the English devotional lyric as a major genre.',bn:'ইংরেজি ভক্তিমূলক গীতিকবিতাকে প্রধান ধারায় প্রতিষ্ঠা করেন।'},quotes:{en:['Love bade me welcome: yet my soul drew back.'],bn:['প্রেম আমাকে স্বাগত জানালো: তবু আমার আত্মা পিছিয়ে গেল।']}},
{id:'samuel-richardson',name:{en:'Samuel Richardson',bn:'স্যামুয়েল রিচার্ডসন'},birth:'1689',death:'1761',period:'neoclassical',intro:{en:'Pioneer of the epistolary novel with Pamela.',bn:'পামেলার মাধ্যমে পত্র-উপন্যাসের পথিকৃৎ।'},description:{en:'Richardson transformed the novel with his epistolary technique. Pamela and Clarissa explored female virtue with unprecedented psychological depth.',bn:'রিচার্ডসন তাঁর পত্রমূলক কৌশলের মাধ্যমে উপন্যাসকে রূপান্তরিত করেছিলেন।'},majorWorks:{en:['Pamela','Clarissa'],bn:['পামেলা','ক্ল্যারিসা']},style:{en:'Epistolary, psychologically detailed.',bn:'পত্রমূলক, মনস্তাত্ত্বিকভাবে বিস্তারিত।'},contribution:{en:'Invented the epistolary novel and pioneered psychological realism.',bn:'পত্র-উপন্যাস উদ্ভাবন করেন।'},quotes:{en:['A good word costs nothing.'],bn:['একটি ভালো কথার কোনো মূল্য নেই।']}},
{id:'oliver-goldsmith',name:{en:'Oliver Goldsmith',bn:'অলিভার গোল্ডস্মিথ'},birth:'1728',death:'1774',period:'neoclassical',intro:{en:'Versatile Irish writer known for She Stoops to Conquer.',bn:'বহুমুখী আইরিশ লেখক।'},description:{en:'Goldsmith excelled in poetry, fiction, and drama. She Stoops to Conquer remains a classic of English theater.',bn:'গোল্ডস্মিথ কবিতা, কথাসাহিত্য এবং নাটকে পারদর্শী ছিলেন।'},majorWorks:{en:['She Stoops to Conquer','The Vicar of Wakefield'],bn:['শি স্টুপস টু কনকার','দ্য ভিকার অফ ওয়েকফিল্ড']},style:{en:'Graceful, humorous, and sentimentally tender.',bn:'সুমধুর এবং হাস্যরসাত্মক।'},contribution:{en:'Revitalized comedy and contributed to multiple genres.',bn:'কমেডিকে পুনরুজ্জীবিত করেন।'},quotes:{en:['Ask me no questions, and I\'ll tell you no fibs.'],bn:['আমাকে কোনো প্রশ্ন করো না।']}},
{id:'john-clare',name:{en:'John Clare',bn:'জন ক্লেয়ার'},birth:'1793',death:'1864',period:'romantic',intro:{en:'The "peasant poet" who wrote with precision about nature.',bn:'"কৃষক কবি" যিনি প্রকৃতি সম্পর্কে নির্ভুলভাবে লিখেছিলেন।'},description:{en:'Clare was a laboring-class poet whose intimate knowledge of the natural world produced some of the most beautiful nature poetry in English.',bn:'ক্লেয়ার একজন শ্রমজীবী কবি ছিলেন।'},majorWorks:{en:['I Am','The Shepherd\'s Calendar'],bn:['আই অ্যাম','দ্য শেফার্ডস ক্যালেন্ডার']},style:{en:'Precise, unadorned nature poetry.',bn:'সুনির্দিষ্ট প্রকৃতি কবিতা।'},contribution:{en:'Created the most ecologically precise Romantic poetry.',bn:'সবচেয়ে পরিবেশগতভাবে সুনির্দিষ্ট রোমান্টিক কবিতা তৈরি করেন।'},quotes:{en:['I am — yet what I am none cares or knows.'],bn:['আমি আছি — তবু আমি কী তা কেউ জানে না।']}},
{id:'william-hazlitt',name:{en:'William Hazlitt',bn:'উইলিয়াম হ্যাজলিট'},birth:'1778',death:'1830',period:'romantic',intro:{en:'Greatest essayist of the Romantic period.',bn:'রোমান্টিক যুগের সর্বশ্রেষ্ঠ প্রাবন্ধিক।'},description:{en:'Hazlitt was a critic and essayist whose passionate prose brought literary criticism alive.',bn:'হ্যাজলিট একজন সমালোচক এবং প্রাবন্ধিক ছিলেন।'},majorWorks:{en:['Characters of Shakespeare\'s Plays','The Spirit of the Age'],bn:['ক্যারেক্টার্স অফ শেকসপিয়ার্স প্লেস','দ্য স্পিরিট অফ দ্য এজ']},style:{en:'Vigorous, passionate critical prose.',bn:'সবল, আবেগপূর্ণ সমালোচনামূলক গদ্য।'},contribution:{en:'Established modern literary criticism.',bn:'আধুনিক সাহিত্য সমালোচনা প্রতিষ্ঠা করেন।'},quotes:{en:['The art of life is to know how to enjoy a little and to endure much.'],bn:['জীবনের শিল্প হলো অল্পে আনন্দ করা এবং অনেক সহ্য করা।']}},
{id:'elizabeth-barrett-browning',name:{en:'Elizabeth Barrett Browning',bn:'এলিজাবেথ ব্যারেট ব্রাউনিং'},birth:'1806',death:'1861',period:'victorian',intro:{en:'Leading female poet of the Victorian era.',bn:'ভিক্টোরীয় যুগের প্রধান নারী কবি।'},description:{en:'Barrett Browning was one of the most prominent English poets. Her Sonnets from the Portuguese contains some of the finest love poetry in English.',bn:'ব্যারেট ব্রাউনিং সবচেয়ে বিশিষ্ট কবিদের একজন ছিলেন।'},majorWorks:{en:['Sonnets from the Portuguese','Aurora Leigh'],bn:['সনেটস ফ্রম দ্য পর্তুগিজ','অরোরা লী']},style:{en:'Passionate, socially conscious verse.',bn:'আবেগপূর্ণ, সামাজিকভাবে সচেতন কবিতা।'},contribution:{en:'Championed women\'s rights through poetry.',bn:'কবিতার মাধ্যমে নারী অধিকারের পক্ষে কথা বলেন।'},quotes:{en:['How do I love thee? Let me count the ways.'],bn:['আমি তোমাকে কতটা ভালোবাসি? চলো গণনা করি।']}},
{id:'christina-rossetti',name:{en:'Christina Rossetti',bn:'ক্রিস্টিনা রোসেটি'},birth:'1830',death:'1894',period:'victorian',image:'https://upload.wikimedia.org/wikipedia/commons/thumb/9/98/Dante_Gabriel_Rossetti_-_Christina_Rossetti.jpg/220px-Dante_Gabriel_Rossetti_-_Christina_Rossetti.jpg',intro:{en:'Devotional and lyrical poet of the Pre-Raphaelite circle.',bn:'প্রি-রাফায়েলাইট বৃত্তের ভক্তিমূলক ও গীতিময় কবি।'},description:{en:'Rossetti\'s poetry combines personal emotion with religious devotion. Goblin Market is a richly symbolic narrative poem.',bn:'রোসেটির কবিতা আবেগ এবং ভক্তিকে একত্রিত করে।'},majorWorks:{en:['Goblin Market','Remember'],bn:['গবলিন মার্কেট','রিমেম্বার']},style:{en:'Musical, symbolic, and devotionally intense.',bn:'সুরেলা, প্রতীকী এবং ভক্তিগভীর।'},contribution:{en:'Created finest devotional lyric poetry of the Victorian age.',bn:'ভিক্টোরীয় যুগের সেরা ভক্তিমূলক কবিতা তৈরি করেন।'},quotes:{en:['Remember me when I am gone away.'],bn:['আমি চলে গেলে আমাকে মনে রেখো।']}},
{id:'rudyard-kipling',name:{en:'Rudyard Kipling',bn:'রুডইয়ার্ড কিপলিং'},birth:'1865',death:'1936',period:'victorian',image:'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Rudyard_Kipling_%28portrait%29.jpg/220px-Rudyard_Kipling_%28portrait%29.jpg',intro:{en:'Nobel Prize winner, voice of the British Empire.',bn:'নোবেল পুরস্কার বিজয়ী, ব্রিটিশ সাম্রাজ্যের কণ্ঠস্বর।'},description:{en:'Kipling was the youngest Nobel laureate in Literature (1907). Born in India, his works celebrate and critique the imperial experience.',bn:'কিপলিং সাহিত্যে সবচেয়ে কম বয়সী নোবেল বিজয়ী ছিলেন।'},majorWorks:{en:['The Jungle Book','Kim','If—'],bn:['দ্য জঙ্গল বুক','কিম','ইফ—']},style:{en:'Vigorous, rhythmic, rich in vernacular speech.',bn:'সবল, ছন্দময়, দেশজ ভাষায় সমৃদ্ধ।'},contribution:{en:'Chronicled the British Empire and created enduring children\'s literature.',bn:'ব্রিটিশ সাম্রাজ্যের ইতিবৃত্ত রচনা করেন।'},quotes:{en:['If you can keep your head when all about you are losing theirs.'],bn:['যদি তুমি মাথা ঠান্ডা রাখতে পারো যখন সবাই তাদেরটা হারাচ্ছে।']}},
{id:'em-forster',name:{en:'E.M. Forster',bn:'ই.এম. ফরস্টার'},birth:'1879',death:'1970',period:'modern',intro:{en:'Humanist novelist known for A Passage to India.',bn:'মানবতাবাদী ঔপন্যাসিক।'},description:{en:'Forster\'s novels explore the clash between cultures, classes, and temperaments. A Passage to India is one of the great novels of the 20th century.',bn:'ফরস্টারের উপন্যাসগুলো বিভিন্ন সংস্কৃতির সংঘর্ষ অন্বেষণ করে।'},majorWorks:{en:['A Passage to India','Howards End','A Room with a View'],bn:['আ প্যাসেজ টু ইন্ডিয়া','হাওয়ার্ডস এন্ড','আ রুম উইথ আ ভিউ']},style:{en:'Humanist, ironic, psychologically perceptive.',bn:'মানবতাবাদী, বিদ্রূপাত্মক।'},contribution:{en:'Explored cross-cultural understanding in the novel form.',bn:'উপন্যাসে আন্তঃসাংস্কৃতিক বোঝাপড়া অন্বেষণ করেন।'},quotes:{en:['Only connect!'],bn:['শুধু সংযুক্ত হও!']}},
{id:'samuel-beckett',name:{en:'Samuel Beckett',bn:'স্যামুয়েল বেকেট'},birth:'1906',death:'1989',period:'modern',intro:{en:'Nobel laureate, master of the Theatre of the Absurd.',bn:'নোবেল বিজয়ী, অ্যাবসার্ড থিয়েটারের ওস্তাদ।'},description:{en:'Beckett\'s Waiting for Godot revolutionized theater by presenting the absurdity of existence with darkly humorous minimalism.',bn:'বেকেটের ওয়েটিং ফর গডো থিয়েটারে বিপ্লব ঘটিয়েছিল।'},majorWorks:{en:['Waiting for Godot','Endgame','Molloy'],bn:['ওয়েটিং ফর গডো','এন্ডগেম','মলয়']},style:{en:'Minimalist, absurdist, existentially stripped.',bn:'ন্যূনতাবাদী, অ্যাবসার্ডিস্ট।'},contribution:{en:'Created the Theatre of the Absurd.',bn:'অ্যাবসার্ড থিয়েটার তৈরি করেন।'},quotes:{en:['Ever tried. Ever failed. No matter. Try again. Fail again. Fail better.'],bn:['চেষ্টা করেছ। ব্যর্থ হয়েছ। কিছু যায় আসে না। আবার চেষ্টা করো।']}},
{id:'dylan-thomas',name:{en:'Dylan Thomas',bn:'ডিলান টমাস'},birth:'1914',death:'1953',period:'modern',intro:{en:'Welsh poet known for exuberant, richly musical verse.',bn:'ওয়েলশ কবি, উচ্ছ্বসিত সুরেলা কবিতার জন্য পরিচিত।'},description:{en:'Thomas wrote some of the most vibrant poetry of the 20th century, celebrating life and death with extraordinary linguistic energy.',bn:'টমাস বিংশ শতাব্দীর সবচেয়ে প্রাণবন্ত কবিতা লিখেছিলেন।'},majorWorks:{en:['Do Not Go Gentle into That Good Night','Under Milk Wood','Fern Hill'],bn:['ডু নট গো জেন্টল','আন্ডার মিল্ক উড','ফার্ন হিল']},style:{en:'Exuberant, richly musical, neo-Romantic.',bn:'উচ্ছ্বসিত, সুরেলা।'},contribution:{en:'Revitalized the music of English poetry.',bn:'ইংরেজি কবিতার সংগীতকে পুনরুজ্জীবিত করেন।'},quotes:{en:['Do not go gentle into that good night.'],bn:['সেই মঙ্গলময় রাত্রিতে নম্রভাবে যেও না।']}},
{id:'angela-carter',name:{en:'Angela Carter',bn:'অ্যাঞ্জেলা কার্টার'},birth:'1940',death:'1992',period:'postmodern',intro:{en:'Feminist fiction writer who reinvented fairy tales.',bn:'নারীবাদী কথাসাহিত্যিক যিনি রূপকথাকে নতুন করে সৃষ্টি করেছিলেন।'},description:{en:'Carter\'s work reimagines myth and fairy tale through a feminist, postmodern lens. The Bloody Chamber subverts traditional fairy tales.',bn:'কার্টারের কাজ নারীবাদী দৃষ্টিকোণ থেকে রূপকথাকে নতুনভাবে কল্পনা করে।'},majorWorks:{en:['The Bloody Chamber','Nights at the Circus'],bn:['দ্য ব্লাডি চেম্বার','নাইটস অ্যাট দ্য সার্কাস']},style:{en:'Baroque, subversive, sensuously ornate.',bn:'বারোক এবং অলঙ্কৃত গদ্য।'},contribution:{en:'Reinvented fairy tales as feminist critique.',bn:'রূপকথাকে নারীবাদী সমালোচনায় রূপান্তরিত করেন।'},quotes:{en:['Comedy is tragedy that happens to other people.'],bn:['কমেডি হলো অন্যের সাথে ঘটা ট্র্যাজেডি।']}},
{id:'seamus-heaney',name:{en:'Seamus Heaney',bn:'শেমাস হিনি'},birth:'1939',death:'2013',period:'postmodern',image:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Seamus_Heaney_2010.jpg/220px-Seamus_Heaney_2010.jpg',intro:{en:'Irish Nobel laureate rooted in Northern Ireland.',bn:'আইরিশ নোবেল বিজয়ী।'},description:{en:'Heaney\'s poetry draws on the rural landscape, Irish history, and the Troubles. He won the Nobel Prize in 1995.',bn:'হিনির কবিতা গ্রামীণ ভূদৃশ্য এবং আইরিশ ইতিহাস থেকে অনুপ্রেরণা নেয়।'},majorWorks:{en:['Death of a Naturalist','North','Beowulf (translation)'],bn:['ডেথ অফ আ ন্যাচারালিস্ট','নর্থ','বেউলফ (অনুবাদ)']},style:{en:'Earthy, sensuous, deeply rooted in landscape.',bn:'মাটিঘেঁষা, সংবেদনশীল।'},contribution:{en:'Made Irish poetry a world literature.',bn:'আইরিশ কবিতাকে বিশ্ব সাহিত্যে পরিণত করেন।'},quotes:{en:['Between my finger and my thumb the squat pen rests; snug as a gun.'],bn:['আমার আঙুল ও বুড়ো আঙুলের মাঝে কলমটি বসে আছে।']}},
{id:'vs-naipaul',name:{en:'V.S. Naipaul',bn:'ভি.এস. নাইপল'},birth:'1932',death:'2018',period:'postmodern',intro:{en:'Nobel laureate who explored displacement and colonialism.',bn:'নোবেল বিজয়ী যিনি স্থানচ্যুতি এবং ঔপনিবেশিকতা অন্বেষণ করেছেন।'},description:{en:'Naipaul explored the aftermath of colonialism with unflinching honesty. He won the Nobel Prize in 2001.',bn:'নাইপল ঔপনিবেশিকতার পরবর্তী প্রভাব অন্বেষণ করেছেন।'},majorWorks:{en:['A House for Mr Biswas','A Bend in the River'],bn:['আ হাউস ফর মিস্টার বিশ্বাস','আ বেন্ড ইন দ্য রিভার']},style:{en:'Precise, detached, unflinchingly honest.',bn:'সুনির্দিষ্ট এবং সৎ গদ্য।'},contribution:{en:'Expanded the English novel with postcolonial perspectives.',bn:'উত্তর-ঔপনিবেশিক দৃষ্টিভঙ্গি দিয়ে ইংরেজি উপন্যাস প্রসারিত করেন।'},quotes:{en:['The world is what it is.'],bn:['পৃথিবী যেমন আছে তেমনই।']}}
];
